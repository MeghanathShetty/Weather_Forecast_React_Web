        ...
        <div className="mid-main">
          ...
          <div className="mid-right">
            <div className="mid-right-part1">
              ...
              {/* <div className="mid-sub1-current-main">
                <div className="mid-sub1-current">
                  <img
                      src={weather?.current?.condition?.icon ?? "/dummy/path"}
                      alt="Weather Forecast"
                    />
              ...
              <h4>Hourly Forecast</h4>
                <div className="mid-sub1-hourly">
                {
                  hourlyWeather && hourlyWeather.map((hourlyData, index) => (
                  <div key={index} className="mid-hour-forecast-sets">
                    <b>{convertTime(hourlyData?.time)}</b>
          ...
          <div className="mid-sub2">
            3 days Forecast
            <div className="mid-sub2-forecast">
              <div className="mid-sub2-forecast-sets">
            ...
            air details
            <div className="mid-sub2-part1">
              <div className="mid-sub2-part1-heading">
                  <h4>Air Quality</h4>
                   <h4>{getAirQuality(weather?.current?.air_quality['us-epa-index'])}</h4>
              </div>
              <b>
                <div className="mid-sub2-part1-row">
                  <div className="mid-sub2-part1-air-left">CO</div>
                  <div className="mid-sub2-part1-air-right">{weather?.current?.air_quality?.co} µg/m³</div>
                </div>
                <div className="mid-sub2-part1-row">
                  <div className="mid-sub2-part1-air-left">NO2</div>
                  <div className="mid-sub2-part1-air-right">{weather?.current?.air_quality?.no2} µg/m³</div>
                </div>
                <div className="mid-sub2-part1-row">
                  <div className="mid-sub2-part1-air-left">SO2</div>
                  <div className="mid-sub2-part1-air-right">{weather?.current?.air_quality?.so2} µg/m³</div>
                </div>
                <div className="mid-sub2-part1-row">
                  <div className="mid-sub2-part1-air-left">O3</div>
                  <div className="mid-sub2-part1-air-right">{weather?.current?.air_quality?.o3} µg/m³</div>
                </div>
                <div className="mid-sub2-part1-row">
                  <div className="mid-sub2-part1-air-left">PM2.5</div>
                  <div className="mid-sub2-part1-air-right">{weather?.current?.air_quality?.pm2_5} µg/m³</div>
                </div>
                <div className="mid-sub2-part1-row">
                  <div className="mid-sub2-part1-air-left">PM10</div>
                  <div className="mid-sub2-part1-air-right">{weather?.current?.air_quality?.pm10} µg/m³</div>
                </div>
                <div className="mid-sub2-part1-row">
                  <div className="mid-sub2-part1-air-left">GB Defra Index</div>
                  <div className="mid-sub2-part1-air-right">{weather?.current?.air_quality['gb-defra-index']}</div>
                </div>
                <div className="mid-sub2-part1-row" style={{ borderBottom: "0px"}}>
                  <div className="mid-sub2-part1-air-left">US EPA Index</div>
                  <div className="mid-sub2-part1-air-right">{weather?.current?.air_quality['us-epa-index']}</div>
                </div>
              </b>
            </div>

            Sky details
            <div className="mid-sub2-part1" style={{ borderBottom: "0px",marginTop:"20px"}}>   
              <div className="mid-sub2-part1-heading">
                  <h4>Sky Conditions</h4>
              </div>
              <b>
                <div className="mid-sub2-part1-row">
                  <div className="mid-sub2-part1-air-left">Moon Illumination</div>
                  <div className="mid-sub2-part1-air-right">{sky_details?.moon_illumination}</div>
                </div>
                <div className="mid-sub2-part1-row">
                  <div className="mid-sub2-part1-air-left">Moon Phase</div>
                  <div className="mid-sub2-part1-air-right">{sky_details?.moon_phase}</div>
                </div>
                <div className="mid-sub2-part1-row">
                  <div className="mid-sub2-part1-air-left">Sun Rise</div>
                  <div className="mid-sub2-part1-air-right">{sky_details?.sunrise}</div>
                </div>
                <div className="mid-sub2-part1-row">
                  <div className="mid-sub2-part1-air-left">Sun Set</div>
                  <div className="mid-sub2-part1-air-right">{sky_details?.sunset}</div>
                </div>
                <div className="mid-sub2-part1-row">
                  <div className="mid-sub2-part1-air-left">Moon Rise</div>
                  <div className="mid-sub2-part1-air-right">{sky_details?.moonrise}</div>
                </div>
                <div className="mid-sub2-part1-row" style={{ borderBottom: "0px"}}>
                  <div className="mid-sub2-part1-air-left">Moon Set</div>
                  <div className="mid-sub2-part1-air-right">{sky_details?.moonset}</div>
                </div>
              </b>
            </div> */}
      </>
